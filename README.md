...
**Analysis** — Claude Sonnet reviews only the amount mismatches and generates open-ended attention points using the [rule set](rules/aandachtspunten.md). The covered/missing/notFilledIn categories are not sent to the LLM.
