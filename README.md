...
`lib/rag/corpus.json` is a committed, pre-embedded corpus of 15 curated Belastingdienst.nl pages (71 chunks) (box 3, hypotheekrenteaftrek, dividendbelasting, aftrekposten) that grounds Analysis in current official guidance — see [ADR 0007](docs/adr/0007-rag-grounding-for-aandachtspunten.md) for the full design.
