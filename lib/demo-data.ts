...
export const DEMO_REPORT_EN: AnalysisReport = {
  ...
  attentionPoints: [
    ...
    },
    {
      ...
      explanation:
        "DeGiro withheld € 64 in foreign withholding tax on foreign dividends. Depending on the treaty country, this amount can be offset via the tax return or claimed as a deductible cost. Check whether it has been correctly processed in box 3.",
      institution: "DeGiro",
      accountNumber: "DG-9876543",
    },
    {
      ...
      explanation:
        "ASN Bank reported a savings balance of € 6.100 that is not in the tax return. Box 3 requires reporting all balances on the reference date of January 1, 2024. Add this amount to your tax return.",
      institution: "ASN Bank",
      accountNumber: "NL11ASNB0987654321",
      initialMessages: [
        {
        ...
        },
        {
          role: "assistant",
          content:
            "If you didn't report the € 6.100 savings balance in box 3, the Belastingdienst can correct this later through an additional tax assessment. A five-year period applies for this.\n\n**Practical advice:**\n- Submit an amended tax return via Mijn Belastingdienst. This is possible up to five years after the tax year.\n- The tax impact is limited: box 3 is taxed based on a deemed return. For € 6.100 in extra assets, the extra tax is usually only about ten euros per year.\n- If your total assets stay below the tax-free threshold (€ 57.000 for single filers in 2024), no extra tax is due at all.",
        },
      ],
    },
  ],
