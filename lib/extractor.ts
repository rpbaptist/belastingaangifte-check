...
- accountNumber is the identifier associated with that entry, or null if none is shown. Dutch IBANs appear as [IBAN:BANKCODE:NNN] pseudonyms in the text — extract them exactly as shown. If the field label embeds a non-IBAN account identifier (e.g. "Bankrekening: ING Creditcardrekening 2100 3093 2649"), extract that identifier into accountNumber as-is, including any spaces. Mortgage entries may use a "Nummer" prefix instead of the standard "Aftrekbare rente van schuld" pattern — for example "Nummer 1926.58.069 / Betaalde rente in 2025: €105" must be extracted as a box 1 entry with accountNumber "Nummer1926.58.069" and amount -105 (negative, as it is a deduction)
